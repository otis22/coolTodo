...
### Быстрая инициализация (скрипт в разработке)

В будущем будет доступен скрипт автоматической инициализации (см. задачу E11):

```bash
./init
```

Скрипт автоматически выполнит все необходимые шаги для настройки проекта.
