...
- [ ] Проверить, доступен ли mysqladmin в Ubuntu runner
- [ ] Определить оптимальное решение
- [ ] Проверить влияние на время выполнения

### Шаг 2: Реализация
- [ ] Установить MySQL client или использовать альтернативу
- [ ] Обновить шаг "Wait for MySQL"
- [ ] Протестировать в CI
