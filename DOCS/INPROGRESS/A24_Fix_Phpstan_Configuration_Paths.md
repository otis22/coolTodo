...
- A23: Исправить права доступа для composer install (связано - нужно установить зависимости)
- A25: Исправить пути к конфигурационным файлам в скрипте dev (решает проблему на уровне скрипта)
