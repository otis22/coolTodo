...
**Статус**: Blocked (временное решение создает дублирование конфигурации, требуется A26)  
**Приоритет**: Medium  
**Оценка**: 0.25 дня
...
**Решение**: Задача A26 создана для системного исправления без дублирования конфигурации.
