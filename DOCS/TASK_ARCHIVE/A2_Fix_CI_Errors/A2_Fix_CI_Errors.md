...
Конфликт версий зависимостей исправлен. CI пайплайн должен теперь успешно устанавливать зависимости.

**Примечание**: PHPStan 1.12.x поддерживает level 9, что соответствует требованиям проекта. Larastan 2.9 совместим с PHPStan 1.12.x.
