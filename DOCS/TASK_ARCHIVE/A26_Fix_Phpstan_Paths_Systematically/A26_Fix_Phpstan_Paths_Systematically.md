...
Задача решена через A28 - унификация структуры Docker. Системное решение реализовано без дублирования конфигураций. PHPStan работает с единой конфигурацией в CI и локально.
