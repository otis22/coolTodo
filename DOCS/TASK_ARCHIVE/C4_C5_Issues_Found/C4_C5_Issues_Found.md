...
**Статус**: ✅ Проверено в браузере - все работает корректно
...
6. ✅ Фильтр "Active" показывает только active задачи
7. ✅ Фильтр "All" показывает все задачи

**Проверено**:
- Создано 4 задачи через API (3 active, 1 completed)
- Кнопка обновления работает - список обновляется
- Фильтры работают корректно:
  - "All" показывает все 4 задачи
  - "Active" показывает 3 active задачи
  - "Completed" показывает 1 completed задачу
